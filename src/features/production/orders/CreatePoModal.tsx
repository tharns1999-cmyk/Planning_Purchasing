...
export const CreatePoModal: React.FC<CreatePoModalProps> = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const mappedLines: CreateSalesOrderLineInput[] = lines.map((l) => ({
      ...
      completedQty: l.completedQty ? parseFloat(l.completedQty) || l.completedQty : undefined,
      shortageQty: l.shortageQty ? parseFloat(l.shortageQty) || l.shortageQty : undefined,
      boxQty: l.boxQty ? parseFloat(l.boxQty) || l.boxQty : undefined,
      note: undefined,
    }));
                ...
                >
                  ...
                  <div className="grid grid-cols-12 gap-2">
                    <div className="col-span-4">
                      <Input
                        label="การบรรจุ"
                        placeholder="เช่น ถุง OPP 5.5x8"
                        value={line.packaging || ''}
                        onChange={(e) => handleLineChange(idx, 'packaging', e.target.value)}
                      />
                    </div>
                    <div className="col-span-3">
                      <Input
                        ...
                        placeholder="เช่น 10"
                        value={line.boxQty || ''}
                        onChange={(e) => handleLineChange(idx, 'boxQty', e.target.value)}
                      />
                    </div>
                    <div className="col-span-2">
                      <Input
                        ...
                        type="number"
                        placeholder="0"
                        value={line.completedQty || ''}
                        onChange={(e) => handleLineChange(idx, 'completedQty', e.target.value)}
                      />
                    </div>
                    <div className="col-span-3">
                      <Input
                        ...
                        onChange={(e) => handleLineChange(idx, 'shortageQty', e.target.value)}
                      />
                    </div>
                  </div>
                </motion.div>
