                  ...
                  >
                    ...
                    <td className="py-3 px-4 whitespace-nowrap text-center" onClick={(e) => e.stopPropagation()}>
                      <select
                        ...
                        className={`text-sm font-normal px-2.5 py-1 rounded-full border focus:outline-none cursor-pointer ${
                          rec.status === 'Open'
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-slate-50/80 p-4 sm:p-5 rounded-2xl border border-slate-200/80 shadow-2xs relative z-30">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full h-11 px-3.5 border rounded-xl text-sm font-mono font-normal transition-all shadow-2xs ${
                        prefillData
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span
                        className={`text-sm font-normal px-2 py-0.5 rounded-full border ${
                          editStatus === 'Open'
