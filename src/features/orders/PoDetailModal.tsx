            ...
            <table className="w-full text-left border-collapse text-xs">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-200 text-slate-700 font-bold">
                  ...
                  <th className="py-2.5 px-3 text-right">วางแผนแล้ว (FG Output)</th>
                  ...
                  return (
                    <React.Fragment key={line.id}>
                      <tr className="hover:bg-slate-50/60 transition-colors">
                        ...
                        <td className="py-2.5 px-3 text-right font-bold text-slate-900">{line.orderedQty.toLocaleString()}</td>
                        <td className="py-2.5 px-3 text-right font-bold text-emerald-600">{activePlannedQty.toLocaleString()}</td>
                        <td className="py-2.5 px-3 text-right font-bold text-amber-600">{remainingQty.toLocaleString()}</td>
